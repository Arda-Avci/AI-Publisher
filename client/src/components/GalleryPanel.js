...
export function GalleryPanel({ jobs, selectedJob, metaYtTitle, metaYtDesc, metaYtTags, isMetaSaving, progressMsg, progressPercent, userCredits, onSelectJob, onRefreshJobs, onCancelJob, onDeleteJob, onSetMetaYtTitle, onSetMetaYtDesc, onSetMetaYtTags, onSaveMetaAndPublish, onAnalyzeViralScore, onSelectCover, t, }) {
    ...
    return (_jsxs("aside", { style: {
            ...
            overflow: 'hidden',
                                ...
                                }, children: [_jsx(Monitor, { size: 14, style: { color: 'var(--accent)' } }), _jsx("span", { style: { fontSize: '11px', fontWeight: 700, color: 'var(--text-muted)', letterSpacing: '0.5px' }, children: "S\u0130STEM LOGLARI" })] }), _jsx("div", { style: {
                            ...
                            overflow: 'hidden', flexShrink: 0,
                                ...
                                }, children: "Son \u00DCretimler" }), _jsx("div", { style: { flex: 1, overflow: 'auto', padding: '0 16px 16px' }, children: _jsx("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }, children: recentProductions.map(job => (_jsx(RecentThumbnail, { job: job, onSelect: () => onSelectJob(job) }, job.id))) }) })] }))] })) : (_jsxs("div", { style: { flex: 1, overflow: 'auto', padding: '16px' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }, children: [_jsx("h4", { style: { fontSize: '12px', fontWeight: 'bold', color: 'var(--text-muted)', letterSpacing: '0.5px' }, children: t('gallery') }), _jsx("button", { onClick: onRefreshJobs, style: {
                                ...
                                cursor: 'pointer', transition: 'var(--transition)', position: 'relative',
                            }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }, children: [_jsxs("span", { style: { fontSize: '11px', fontWeight: 'bold', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }, children: ["Proje #", job.id] }), _jsx(StatusBadge, { status: job.status })] }), _jsx("div", { style: {
                                    ...
                                    }, children: ["Sahneler: ", job.completed_scenes, " / ", job.total_scenes, " | Model: ", job.model_type || 'CogVideo'] }), _jsx("button", { onClick: (e) => { e.stopPropagation(); onDeleteJob(job.id); }, title: "Projeyi Sil", style: {
...
function RecentThumbnail({ job, onSelect }) {
    ...
    return (_jsx("div", { onClick: onSelect, style: {
            ...
            overflow: 'hidden',
        }, onMouseOver: e => { e.currentTarget.style.opacity = '1'; }, onMouseOut: e => { e.currentTarget.style.opacity = '0.5'; }, title: job.master_prompt, children: !coverUrl && _jsx(Video, { size: 20, style: { color: 'var(--text-muted)', opacity: 0.4 } }) }));
}
...
function ProgressTracker({ progressMsg, progressPercent, onCancel, }) {
    return (_jsxs("div", { className: "glass", style: {
        ...
        }, children: [_jsx("h4", { style: { fontSize: '12px', fontWeight: 'bold', color: 'var(--accent)', marginBottom: '8px' }, children: "\u0130lerleme" }), _jsxs("div", { style: { fontSize: '11px', marginBottom: '8px', display: 'flex', justifyContent: 'space-between' }, children: [_jsxs("span", { children: ["A\u015Fama: ", _jsx("strong", { children: progressMsg })] }), _jsxs("span", { children: [progressPercent, "%"] })] }), _jsx("div", { style: { height: '6px', background: 'var(--bg-primary)', borderRadius: '3px', overflow: 'hidden' }, children: _jsx("div", { style: {
...
function MetaEditor({ job, ytTitle, ytDesc, ytTags, isSaving, onSetYtTitle, onSetYtDesc, onSetYtTags, onSave, onAnalyzeViralScore, onSelectCover, onRefreshJobs, }) {
    ...
    return (_jsxs("div", { className: "glass", style: {
            ...
            display: 'flex', flexDirection: 'column', gap: '12px',
                    ...
                    gap: '12px'
                }, children: [_jsx("div", { style: { fontSize: '11px', fontWeight: 'bold', color: 'var(--accent)', letterSpacing: '0.05em' }, children: "AI PREMIUM KURGU ARA\u00C7LARI" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '4px' }, children: _jsxs("button", { onClick: handleGazeFix, disabled: kurguLoading, style: {
                                padding: '8px',
                                borderRadius: '6px',
                                border: '1px solid var(--border)',
                                ...
                                gap: '6px'
                                    ...
                                    fontWeight: 600,
                                    cursor: kurguLoading ? 'not-allowed' : 'pointer'
                                }, children: "Sesi \u0130yile\u015Ftir (Studio Sound)" })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px', padding: '8px', borderRadius: '6px', background: 'rgba(0,0,0,0.2)' }, children: [_jsx("div", { style: { fontSize: '10px', fontWeight: 600, color: 'var(--text-muted)' }, children: "Ak\u0131ll\u0131 Yeniden \u00C7er\u00E7eveleme (9:16)" }), _jsxs("label", { style: { display: 'flex', alignItems: 'center', gap: '4px', fontSize: '10px', cursor: 'pointer' }, children: [_jsx("input", { type: "checkbox", checked: useFaceTracking, onChange: e => setUseFaceTracking(e.target.checked) }), " OpenCV Y\u00FCz Takibi Kullan"] }), _jsx("button", { onClick: handleReframe, disabled: kurguLoading, style: {
                                    padding: '6px',
                                    borderRadius: '4px',
                                    border: 'none',
                                    ...
                                    fontWeight: 600,
                                    cursor: kurguLoading ? 'not-allowed' : 'pointer'
                                }, children: "Se\u00E7ilen Alan\u0131 Maskele ve Sil" })] })] }), _jsxs("button", { onClick: onSave, disabled: isSaving, className: "btn btn-primary", style: { width: '100%', fontSize: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }, children: [isSaving ? _jsx(Loader, { size: 12, className: "pulse" }) : _jsx(Share2, { size: 12 }), isSaving ? 'Kaydediliyor...' : (job.status === 'awaiting_approval' ? 'Onayla ve Yayınla' : 'Metinleri Kaydet ve Paylaş')] })] }));
}
...
function DockerStatusPanel() {
    ...
    return (_jsxs("div", { className: "glass", style: {
            ...
            display: 'flex', flexDirection: 'column', gap: '10px',
                            ...
                            boxShadow: isRunning ? '0 0 6px #22c55e' : '0 0 6px #ef4444',
                        } })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '11px' }, children: [_jsx(Row, { label: "GPU", value: _jsxs("span", { style: { display: 'flex', alignItems: 'center', gap: '4px' }, children: [gpuModel, isL4 && _jsx(Zap, { size: 10, style: { color: '#eab308' }, "aria-label": "L4" })] }) }), _jsx(Row, { label: "VRAM", value: vramTotal > 0 ? `${vramUsed.toFixed(1)} / ${vramTotal.toFixed(1)} GB` : '—' }), _jsx(Row, { label: "Durum", value: _jsx("span", { style: { color: isRunning ? '#22c55e' : '#ef4444' }, children: isRunning ? 'Çalışıyor' : 'Durduruldu' }) })] }), _jsxs("button", { onClick: handleTestModels, className: "btn btn-primary", style: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontSize: '11px', padding: '6px 10px' }, children: [_jsx(Beaker, { size: 12 }), "Modelleri Test Et"] }), testOpen && testResults && (_jsxs("div", { style: { marginTop: '4px', borderTop: '1px solid var(--border)', paddingTop: '10px' }, children: [_jsxs("div", { onClick: () => setTestOpen(!testOpen), style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', fontSize: '11px', color: 'var(--text-muted)', fontWeight: 600 }, children: ["Test Sonu\u00E7lar\u0131", testOpen ? _jsx(ChevronUp, { size: 12 }) : _jsx(ChevronDown, { size: 12 })] }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px', marginTop: '8px' }, children: testResults.map((r, i) => (_jsxs("div", { style: {
                                ...
                                padding: '6px 8px', borderRadius: '6px', background: 'rgba(0,0,0,0.25)', fontSize: '10px', fontFamily: 'var(--font-mono)',
                                    ...
                                    }, children: [r.status === 'loaded' || r.status === 'ok' ? '✓' : r.status === 'error' ? '✗' : r.status, r.vram != null ? `  ${r.vram.toFixed(1)} GB` : '', r.error ? `  ${r.error}` : ''] })] }, i))) })] })), testLoading && (_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontSize: '11px', color: 'var(--text-muted)' }, children: [_jsx(Loader, { size: 12, className: "pulse" }), "Test ediliyor..."] }))] }));
}
function CreditsBadge({ credits, limit, resetDate }) {
    ...
    return (_jsxs("div", { className: "glass", style: {
        ...
        }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsx("span", { style: { fontSize: '11px', fontWeight: 600, color: 'var(--text-muted)' }, children: "Krediniz" }), _jsxs("span", { style: { fontSize: '13px', fontWeight: 'bold', color: 'white' }, children: [credits, " ", _jsxs("span", { style: { fontSize: '11px', color: 'var(--text-muted)', fontWeight: 400 }, children: ["/ ", limit] })] })] }), _jsx("div", { style: { height: '4px', background: 'var(--bg-primary)', borderRadius: '2px', overflow: 'hidden' }, children: _jsx("div", { style: { width: `${Math.min(ratio * 100, 100)}%`, height: '100%', background: barColor, transition: 'width 0.3s ease' } }) }), resetDate && (_jsxs("div", { style: { fontSize: '9px', color: 'var(--text-muted)', textAlign: 'right', fontFamily: 'var(--font-mono)' }, children: ["S\u0131f\u0131rlanma: ", new Date(resetDate).toLocaleDateString('tr-TR')] }))] }));
}
