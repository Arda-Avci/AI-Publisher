...
export function ApiKeyManager({ language: _language, t, onShowToast }: ApiKeyManagerProps) {
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  {apiKey.lastUsedAt && (
                    <span style={{ fontSize: '10px', color: '#6B7280' }}>
                      {t('last_used')} {formatDate(apiKey.lastUsedAt)}
                    </span>
                  )}
                </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting || (!editingKey && !formKey.trim())}
                  style={{
                    padding: '10px 24px',
