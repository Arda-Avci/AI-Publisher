...
export function CharacterSelectorModal({ isOpen, onClose, onConfirm, detectedNames, existingCharacters, csrfToken, }) {
    ...
    if (!isOpen)
        return null;
    return (_jsx("div", { style: sty.overlay, onClick: (e) => {
            if (e.target === e.currentTarget)
                onClose();
        }, children: _jsxs("div", { style: sty.modal, children: [_jsxs("div", { style: sty.header, children: [_jsxs("div", { style: sty.title, children: [_jsx(Users, { size: 18, style: { color: 'var(--primary)' } }), "Karakter Atamas\u0131"] }), _jsx("button", { onClick: onClose, style: {
                                background: 'none',
                                border: 'none',
                                cursor: 'pointer',
                                padding: '4px',
                                borderRadius: '4px',
                            }, children: _jsx(X, { size: 18, style: { color: 'var(--text-muted)' } }) })] }), detectedNames.length === 0 ? (_jsxs("div", { style: sty.empty, children: [_jsx(Users, { size: 24, style: { margin: '0 auto 12px', opacity: 0.3 } }), _jsx("div", { children: "Prompt'ta hi\u00E7 @karakter etiketi bulunamad\u0131." })] })) : (_jsxs("div", { style: sty.body, children: [_jsxs("p", { style: { fontSize: '12px', color: 'var(--text-muted)', margin: 0, lineHeight: 1.5 }, children: ["A\u015Fa\u011F\u0131daki karakterler prompt'unuzda", ' ', _jsx("code", { style: {
                                        background: 'rgba(0,242,254,0.08)',
                                        padding: '1px 4px',
                                        borderRadius: '3px',
                                    }, children: "@" }), ' ', "ile i\u015Faretlendi. Her birini var olan bir karakterle e\u015Fle\u015Ftirin, yeni karakter tan\u0131mlay\u0131n veya AI'ya olu\u015Fturtun."] }), assignments.map((a) => {
