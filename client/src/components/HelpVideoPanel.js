...
export function HelpVideoPanel({ feature, language, onClose }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { onClick: () => setSelectedVideo(videos[0]), style: {
                ...
                }, onMouseEnter: (e) => { e.currentTarget.style.transform = 'scale(1.1)'; }, onMouseLeave: (e) => { e.currentTarget.style.transform = 'scale(1)'; }, title: language === 'tr' ? 'Yardım Videoları' : 'Help Videos', children: _jsx(HelpCircle, { size: 24, color: "white" }) }), selectedVideo && (_jsx("div", { style: {
                        ...
                        display: 'flex', flexDirection: 'column',
                                ...
                                display: 'flex', flexDirection: 'column', gap: '16px',
                                        ...
                                        position: 'relative', overflow: 'hidden',
                                                ...
                                                }, children: [_jsx(Clock, { size: 12 }), formatDuration(selectedVideo.durationSeconds)] }))] })) }), _jsx("div", { children: _jsx("p", { style: { fontSize: '14px', color: 'var(--text-muted)', lineHeight: 1.6, margin: 0 }, children: selectedVideo.description }) }), _jsxs("div", { children: [_jsx("span", { style: { fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', marginBottom: '8px', display: 'block' }, children: language === 'tr' ? 'TÜM VİDEOLAR' : 'ALL VIDEOS' }), _jsx("div", { style: { display: 'flex', gap: '12px', overflowX: 'auto', paddingBottom: '8px' }, children: videos.map((video, idx) => (_jsxs("div", { onClick: () => {
    ...
    return (_jsx("div", { style: {
            ...
            onClose(); }, children: _jsxs("div", { style: {
                ...
                display: 'flex', flexDirection: 'column',
                        ...
                        padding: '16px 20px', display: 'flex', justifyContent: 'space-between',
                        alignItems: 'center', borderBottom: '1px solid var(--border)',
                    }, children: [_jsx("h3", { style: { margin: 0, fontSize: '16px', fontWeight: 700 }, children: title }), _jsx("button", { onClick: onClose, style: { background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-muted)' }, children: _jsx(X, { size: 20 }) })] }), _jsxs("div", { style: { padding: '20px', overflow: 'auto' }, children: [videoUrl ? (_jsx("video", { src: videoUrl, controls: true, style: { width: '100%', borderRadius: '8px' } })) : (_jsx("div", { style: {
                                aspectRatio: '16/9', background: 'var(--bg-primary)', borderRadius: '8px',
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                            }, children: _jsx("span", { style: { color: 'var(--text-muted)' }, children: language === 'tr' ? 'Video yakında eklenecek' : 'Video coming soon' }) })), description && (_jsx("p", { style: { fontSize: '14px', color: 'var(--text-muted)', marginTop: '16px', lineHeight: 1.6 }, children: description }))] })] }) }));
}
