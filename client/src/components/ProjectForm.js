...
function TemplateCard({ tpl, isSelected, onSelect, t, }) {
    ...
    return (_jsxs("div", { onClick: onSelect, className: "glass", style: {
            ...
            e.currentTarget.style.borderColor = 'var(--accent)'; }, onMouseLeave: (e) => { if (!isSelected)
            e.currentTarget.style.borderColor = 'var(--border)'; }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("div", { style: {
                            width: '14px', height: '14px', borderRadius: '50%',
                            border: `2px solid ${isSelected ? 'var(--accent)' : 'var(--text-muted)'}`,
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                        }, children: isSelected && _jsx("div", { style: { width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent)' } }) }), _jsx("span", { style: { fontSize: '12px', fontWeight: 'bold', color: isSelected ? 'white' : 'var(--text-muted)' }, children: t(titleKey) || tpl.toUpperCase() }), modelInfo && (_jsxs("span", { style: { fontSize: '9px', color: 'var(--gold)', fontFamily: 'var(--font-mono)', marginLeft: 'auto' }, children: [modelInfo.model, " ", modelInfo.speed] }))] }), _jsx("p", { style: { fontSize: '10px', color: 'var(--text-muted)', margin: 0, paddingLeft: '22px' }, children: t(descKey) || '' })] }));
}
export function ProjectForm(props) {
    ...
    return (_jsx("aside", { style: {
            ...
            flexShrink: 0, overflow: 'hidden',
                ...
                gap: '32px', overflowY: 'auto', flex: 1,
            }, children: [_jsxs("div", { style: sectionStyle, children: [_jsxs("div", { style: { ...labelStyle, display: 'flex', justifyContent: 'space-between' }, children: ["Model Motoru", _jsx("span", { style: { color: 'var(--accent)' }, children: "PRO" })] }), _jsx("select", { value: props.selectedModel, onChange: (e) => props.onSetSelectedModel(e.target.value), style: {
                                ...inputStyle,
                            ...
                            }, children: MODELS.map((m) => _jsx("option", { children: m }, m)) })] }), _jsxs("div", { style: sectionStyle, children: [_jsx("div", { style: labelStyle, children: "En-Boy Oran\u0131" }), _jsx("div", { style: {
                                ...
                                return (_jsxs("button", { type: "button", onClick: () => props.onSetAspectRatio(ratio), style: {
                                    ...
                                    fontFamily: 'var(--font-sans)',
                                    outline: 'none',
                                }, children: [enhancing ? _jsx(Loader, { size: 11, className: "pulse" }) : _jsx(Wand2, { size: 11 }), "Yapay Zeka ile Geli\u015Ftir"] }), children: _jsx("textarea", { required: true, value: props.masterPrompt, onChange: (e) => props.onSetMasterPrompt(e.target.value), placeholder: "Yapay zeka modellerinin video hikayesini olu\u015Fturmas\u0131 i\u00E7in master prompt girin...", style: { ...textareaStyle, height: '80px' } }) }), _jsx(Divider, {}), _jsx(Field, { label: props.t('notes'), labelStyle: labelStyle, children: _jsx("textarea", { value: props.productionNotes, onChange: (e) => props.onSetProductionNotes(e.target.value), placeholder: "S\u00FCre tercihleri, ton veya sahne ak\u0131\u015F\u0131 notlar\u0131...", style: { ...textareaStyle, height: '60px' } }) }), _jsx(Field, { label: props.t('charSpecs'), labelStyle: labelStyle, children: _jsx("input", { type: "text", value: props.characterFeatures, onChange: (e) => props.onSetCharacterFeatures(e.target.value), placeholder: "\u00D6rn: Mavi g\u00F6zl\u00FC sar\u0131\u015F\u0131n erkek \u00E7ocuk, Pixar stili", style: inputStyle }) }), _jsx(Divider, {}), _jsx(Field, { label: "Ba\u015Flang\u0131\u00E7 Referans G\u00F6rseli / Videosu", labelStyle: labelStyle, children: _jsx("input", { type: "file", accept: "image/*,video/*", onChange: (e) => props.onSetSelectedFile(e.target.files?.[0] || null), style: { fontSize: '12px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' } }) }), _jsx(Field, { label: "Arka Plan M\u00FCzi\u011Fi (Background Music)", labelStyle: labelStyle, children: _jsx("input", { type: "file", accept: "audio/*", onChange: (e) => props.onSetSelectedMusicFile(e.target.files?.[0] || null), style: { fontSize: '12px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' } }) }), _jsx(Divider, {}), _jsxs("div", { children: [_jsx("div", { style: { ...labelStyle, marginBottom: '8px' }, children: props.t('productionTemplate') }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' }, children: [TEMPLATES.map((tpl) => (_jsx(TemplateCard, { tpl: tpl.key, isSelected: props.productionTemplate === tpl.key, onSelect: () => props.onSetProductionTemplate(tpl.key), t: props.t }, tpl.key))), _jsxs("div", { style: { marginTop: 8, padding: '8px 10px', borderRadius: 6, background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border)' }, children: [_jsx("label", { style: { fontSize: 10, color: 'var(--text-muted)', display: 'block', marginBottom: 4 }, children: "Model (Geli\u015Fmi\u015F)" }), _jsx("select", { value: props.productionTemplate, onChange: e => props.onSetProductionTemplate(e.target.value), style: {
