...
export const Opportunities = ({ onUseAsPrompt }) => {
    ...
    return (_jsxs("div", { className: "opportunities-container", style: { display: 'flex', flexDirection: 'column', gap: '15px' }, children: [_jsxs("div", { style: { display: 'flex', gap: '10px', alignItems: 'center' }, children: [_jsx(TrendingUp, { size: 16, style: { color: 'var(--primary)' } }), _jsx("span", { style: { fontWeight: 600, fontSize: '14px', letterSpacing: '0.5px' }, children: "FIRSATLAR HUN\u0130S\u0130 (VIRAL TRENDS)" })] }), _jsxs("div", { style: { display: 'flex', gap: '10px' }, children: [_jsxs("div", { style: { position: 'relative', flexGrow: 1 }, children: [_jsx(Search, { size: 16, style: {
                                    position: 'absolute',
                                    left: '10px',
                                    top: '50%',
                                    transform: 'translateY(-50%)',
                                    color: 'var(--text-muted)',
                                } }), _jsx("input", { type: "text", placeholder: "Viral trend aramas\u0131...", value: query, onChange: (e) => setQuery(e.target.value), onKeyDown: (e) => e.key === 'Enter' && fetchOpportunities(), style: {
                                    width: '100%',
                ...
                }, children: [_jsx(AlertCircle, { size: 16, style: { flexShrink: 0, marginTop: '2px' } }), _jsx("span", { children: errorMsg })] })), loading ? (_jsxs("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    gap: '8px',
                        ...
                        e.currentTarget.style.boxShadow = 'none';
                                ...
                                overflow: 'hidden',
                                position: 'relative',
                            }, children: [_jsx("img", { src: video.thumbnail, alt: video.title, style: { width: '100%', height: '100%', objectFit: 'cover' } }), _jsxs("div", { style: {
                                        position: 'absolute',
                                        top: '4px',
                                        left: '4px',
                                        ...
                                        height: '32px',
                                        lineHeight: '16px',
                                    }, children: video.title }), _jsxs("div", { style: {
                                        display: 'flex',
                                        ...
                                        marginTop: '2px',
                                                ...
                                                whiteSpace: 'nowrap',
                                                maxWidth: '90px',
                                            }, children: video.channelTitle }), _jsxs("span", { style: { display: 'flex', alignItems: 'center', gap: '2px', flexShrink: 0 }, children: [_jsx(Eye, { size: 10 }), " ", formatViews(video.views)] })] })] })] }, video.videoId))) })) : (_jsx("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    height: '110px',
                    ...
                    color: 'var(--text-muted)',
                    fontSize: '13px',
                }, children: "Taramaya ba\u015Flamak i\u00E7in arama yap\u0131n." })), selectedVideo && (_jsx("div", { className: "modal-overlay glass", style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    width: '100vw',
