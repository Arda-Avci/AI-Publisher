                    ...
                    background: 'var(--bg-surface)',
                            ...
                            background: 'var(--bg-primary)',
                                    ...
                                    fontSize: '12px',
                                            ...
                                            cursor: 'pointer',
                                            fontSize: '12px',
                                        }, children: "\u2715" })] })] })), _jsx("div", { style: { flex: 1, overflow: 'auto', padding: '8px' }, children: sessions.length === 0 ? (_jsx("p", { style: {
                                fontSize: '12px',
                                color: 'var(--text-muted)',
                                textAlign: 'center',
                                padding: '20px',
                            }, children: t('noSessions') })) : (sessions.map((session) => (_jsx("div", { onClick: () => loadSession(session.id), style: {
                                padding: '12px',
                                borderRadius: '8px',
                                marginBottom: '4px',
                                cursor: 'pointer',
                                background: currentSession?.id === session.id ? 'var(--accent-light)' : 'transparent',
                                ...
                                if (currentSession?.id !== session.id) {
                                    ...
                                    alignItems: 'flex-start',
                                }, children: [_jsxs("div", { style: { flex: 1, overflow: 'hidden' }, children: [_jsxs("p", { style: {
                                                    fontSize: '13px',
                                                    fontWeight: 600,
                                                    margin: 0,
                                                    overflow: 'hidden',
                                                    ...
                                                    whiteSpace: 'nowrap',
                                                }, children: [_jsx(MessageSquare, { size: 12, style: { marginRight: '6px', verticalAlign: 'middle' } }), session.lastMessage?.slice(0, 30) || 'Yeni Sohbet', "..."] }), _jsx("p", { style: { fontSize: '11px', color: 'var(--text-muted)', margin: '4px 0 0' }, children: session.updatedAt ? new Date(session.updatedAt).toLocaleDateString() : '' })] }), _jsx("button", { onClick: (e) => {
                                            e.stopPropagation();
                        ...
                        gap: '16px',
                        color: 'var(--text-muted)',
                    }, children: [_jsx(Sparkles, { size: 48, style: { opacity: 0.5 } }), _jsx("p", { style: { fontSize: '14px' }, children: language === 'tr'
                                ? 'Sohbet seçin veya yeni başlatın'
                                : 'Select or start a conversation' })] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { style: {
                                padding: '12px 16px',
                                borderBottom: '1px solid var(--border)',
                                display: 'flex',
                                alignItems: 'center',
                                ...
                                gap: '12px',
                                    ...
                                    } }), _jsxs("button", { onClick: sendMessage, disabled: !message.trim() || loading, style: {
                                        padding: '12px 20px',
                                        borderRadius: '12px',
