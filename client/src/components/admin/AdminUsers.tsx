...
export default function AdminUsers() {
  ...
  const handleSearch = (e: React.FormEvent) => { e.preventDefault(); setOffset(0); fetchUsers(); };
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-800 bg-gray-900/80">
                ...
                <th className="text-left py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Lang</th>
                <th className="text-left py-3 px-4 text-xs font-medium text-gray-500 uppercase tracking-wider">Theme</th>
