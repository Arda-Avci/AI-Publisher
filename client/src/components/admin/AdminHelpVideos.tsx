    ...
    <>
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm bg-gray-800 border border-gray-700 rounded-lg focus:ring-1 focus:ring-amber-500 focus:border-amber-500 outline-none text-gray-200"
          required
        />
      </div>
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-gray-900 bg-amber-400 hover:bg-amber-500 rounded-lg transition-colors"
        >
          + Add Video
        </button>
      </div>
      ...
      {showAdd && (
        <form
          ...
          className="p-4 mb-6 bg-gray-800/50 border border-gray-700 rounded-xl"
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2 justify-end pt-2">
              ...
              <button
                type="submit"
                className="px-4 py-1.5 text-sm font-medium text-gray-900 bg-amber-400 hover:bg-amber-500 rounded-lg transition-colors"
              >
                Create
              </button>
            </div>
      ...
      {editing && (
        <form
          ...
          className="p-4 mb-6 bg-gray-800/50 border border-amber-500/30 rounded-xl"
        >
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {videos.map((v) => (
            <div
              key={v.id}
              className="flex items-center gap-4 p-3 bg-gray-800/30 border border-gray-700/50 rounded-lg hover:border-gray-600 transition-colors"
            >
