    ...
    return (_jsxs("div", { style: {
            ...
            overflow: 'hidden'
                            ...
                            border: '1px solid rgba(139, 92, 246, 0.3)',
                                    ...
                                    paddingTop: '8px'
                                            ...
                                            letterSpacing: '0.05em'
                                                    ...
                                                    fontSize: '11px',
                                                    outline: 'none',
                                                }, children: [_jsx("option", { value: "center", children: language === 'tr' ? 'Merkez Odaklama' : 'Center Crop' }), _jsx("option", { value: "face_tracking", children: language === 'tr' ? 'Aktif Yüz Takibi (Faz G)' : 'Active Face Tracking (Phase G)' }), _jsx("option", { value: "static", children: language === 'tr' ? 'Statik Geniş Ekran (16:9)' : 'Static Widescreen (16:9)' })] })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '4px', marginBottom: '8px' }, children: [_jsx("label", { style: { fontSize: '10px', color: '#9CA3AF' }, children: language === 'tr' ? 'A/B Split-Screen Düzeni' : 'A/B Split-Screen Layout' }), _jsxs("select", { value: splitLayout, onChange: e => setSplitLayout(e.target.value), style: {
                                                    padding: '6px 8px',
                                                    background: 'rgba(0, 0, 0, 0.5)',
                                                    border: '1px solid rgba(255,255,255,0.1)',
                                                    borderRadius: '4px',
                                                    ...
                                                    fontSize: '11px',
                                                    outline: 'none',
                                                }, children: [_jsx("option", { value: "none", children: language === 'tr' ? 'Dikey Tek Ekran' : 'Single Vertical' }), _jsx("option", { value: "vertical", children: language === 'tr' ? 'Üst/Alt Bölünmüş Ekran' : 'Top/Bottom Split' }), _jsx("option", { value: "horizontal", children: language === 'tr' ? 'Yan Yana Bölünmüş Ekran' : 'Side-by-Side Split' })] })] }), splitLayout !== 'none' && (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '4px', marginBottom: '8px' }, children: [_jsx("label", { style: { fontSize: '10px', color: '#9CA3AF' }, children: language === 'tr' ? 'Alt Ekran Video Şablonu' : 'Bottom Screen Template' }), _jsxs("select", { value: bottomTemplate, onChange: e => setBottomTemplate(e.target.value), style: {
                                                    padding: '6px 8px',
                                                    background: 'rgba(0, 0, 0, 0.5)',
                                                    border: '1px solid rgba(255,255,255,0.1)',
                                                    borderRadius: '4px',
                                                    ...
                                                    fontSize: '11px',
                                                    outline: 'none',
                                                }, children: [_jsx("option", { value: "none", children: language === 'tr' ? 'Orijinal Ses' : 'Original Audio' }), _jsx("option", { value: "tr", children: "T\u00FCrk\u00E7e (Dublaj)" }), _jsx("option", { value: "en", children: "English (Dubbing)" }), _jsx("option", { value: "de", children: "Deutsch (Dubbing)" }), _jsx("option", { value: "es", children: "Espa\u00F1ol (Dubbing)" })] })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', marginBottom: '8px' }, children: [_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '4px' }, children: [_jsx("label", { style: { fontSize: '10px', color: '#9CA3AF' }, children: language === 'tr' ? 'Altyazı Stili' : 'Subtitle Style' }), _jsxs("select", { value: subtitleStyle, onChange: e => setSubtitleStyle(e.target.value), style: {
                                                            padding: '6px 8px',
                                                            background: 'rgba(0, 0, 0, 0.5)',
                                                            border: '1px solid rgba(255,255,255,0.1)',
                                                            borderRadius: '4px',
                    ...
                    overflow: 'hidden'
                        ...
                        }, children: [_jsx("h4", { style: { margin: '0 0 4px 0', fontSize: '11px', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.05em' }, children: language === 'tr' ? 'Clipper Görev Geçmişi' : 'Clipper Job History' }), jobs.map(job => {
                            ...
                            }), jobs.length === 0 && !isLoading && (_jsx("div", { style: { padding: '16px', color: 'var(--text-muted)', fontSize: '11px', textAlign: 'center' }, children: language === 'tr' ? 'Henüz kırpma görevi oluşturulmadı.' : 'No clipping jobs created yet.' }))] }), _jsxs("div", { style: {
                            flex: 1,
                            display: 'flex',
                            flexDirection: 'column',
                            gap: '8px',
                            overflow: 'auto'
                                        ...
                                        : (language === 'tr' ? 'Çıkartılan Viral Klipler' : 'Extracted Viral Clips') }) }), selectedJob ? (_jsxs("div", { style: {
                                    flex: 1,
                                    overflowY: 'auto',
                                    display: 'grid',
                                    ...
                                    gap: '10px',
                                    paddingBottom: '12px'
                                }, children: [selectedJob.status === 'completed' && selectedJob.segments?.map(segment => (_jsxs("div", { style: {
                                            ...
                                            overflow: 'hidden'
                                                    ...
                                                    boxShadow: '0 2px 6px rgba(236, 72, 153, 0.3)'
                                                            ...
                                                            }, children: ["\u23F1\uFE0F ", segment.startTime.toFixed(1), "s - ", segment.endTime.toFixed(1), "s (", segment.duration.toFixed(1), "s)"] }) }), _jsx("h5", { style: { margin: '0 0 4px 0', fontSize: '12px', fontWeight: 600, color: '#F3F4F6' }, children: segment.suggestedCaption || (language === 'tr' ? 'Klip Başlığı' : 'Clip Caption') }), _jsx("p", { style: { margin: '0 0 6px 0', fontSize: '11px', color: 'var(--text-muted)', lineHeight: 1.3 }, children: segment.reason || 'General viral momentum' }), segment.suggestedHashtags && segment.suggestedHashtags.length > 0 && (_jsx("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '4px', marginBottom: '8px' }, children: segment.suggestedHashtags.map((tag, idx) => (_jsx("span", { style: { fontSize: '9px', color: '#C4B5FD', fontFamily: 'var(--font-mono)' }, children: tag }, idx))) }))] }), _jsxs("div", { style: { display: 'flex', gap: '6px', marginTop: '6px' }, children: [_jsx("button", { onClick: () => handleExportSegment(selectedJob.id, segment.id), style: {
                                                            flex: 1,
                                                            padding: '6px 10px',
                                                            ...
                                                            cursor: 'pointer',
                                                            transition: 'all 0.2s'
                                                        }, onMouseEnter: e => e.currentTarget.style.background = 'rgba(16, 185, 129, 0.25)', onMouseLeave: e => e.currentTarget.style.background = 'rgba(16, 185, 129, 0.15)', children: language === 'tr' ? 'Kırp ve Export' : 'Crop & Export' }), _jsx("button", { onClick: () => onShowToast?.(language === 'tr' ? 'Sosyal Medya Yayın Motoru Tetiklendi!' : 'Social Media Publisher Triggered!', 'success'), style: {
                                                            padding: '6px 10px',
                                            ...
                                            color: 'var(--text-muted)'
                                                    ...
                                                    animation: 'spin 1s linear infinite',
                                                    marginBottom: '12px'
                                                } }), _jsx("div", { style: { fontSize: '13px', fontWeight: 500, color: '#E5E7EB' }, children: language === 'tr' ? 'Video Deşifre Ediliyor ve Viral Segmentler Analiz Ediliyor...' : 'Transcribing and Analyzing Video Highlights...' }), _jsx("div", { style: { fontSize: '11px', marginTop: '4px' }, children: language === 'tr' ? 'Lütfen bekleyin, bu işlem videonun uzunluğuna bağlı olarak birkaç dakika sürebilir.' : 'Please wait, this might take a few minutes depending on the video length.' })] })), selectedJob.status === 'failed' && (_jsxs("div", { style: { gridColumn: '1 / -1', padding: '24px', textAlign: 'center', color: '#F87171', fontSize: '12px' }, children: ["\u274C ", language === 'tr' ? 'Kırpıcı analizi başarısız oldu.' : 'Clipper analysis failed.'] }))] })) : (_jsxs("div", { style: {
                                    flex: 1,
                                    display: 'flex',
                                    flexDirection: 'column',
                                    alignItems: 'center',
