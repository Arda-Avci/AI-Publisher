...
import { X, User, Palette, Globe, Monitor, Mic, Save, Loader, Upload, Sparkles, Trash2, Wand2, Coins, CreditCard, RefreshCw, Key, } from 'lucide-react';
...
export function SettingsModal({ isOpen, onClose, language, theme, isDark, csrfToken, onSetTheme, onToggleDark, onToggleLanguage, onLogout, t, }) {
    ...
    const tabs = [
        ...
        { id: 'apikeys', label: t('api_keys') || 'API Anahtarları', icon: _jsx(Key, { size: 16 }) },
        { id: 'credits', label: 'Krediler', icon: _jsx(Coins, { size: 16 }) },
        { id: 'payments', label: 'Ödemeler', icon: _jsx(CreditCard, { size: 16 }) },
        { id: 'subscriptions', label: 'Abonelikler', icon: _jsx(RefreshCw, { size: 16 }) },
    ];
    return (_jsx("div", { style: s.overlay, onClick: (e) => {
            if (e.target === e.currentTarget)
                onClose();
        }, children: _jsxs("div", { style: s.modal, children: [_jsxs("div", { style: s.header, children: [_jsxs("div", { style: s.headerTitle, children: [_jsx(Sparkles, { size: 18 }), " ", t('settingsTitle') || 'Ayarlar'] }), _jsx("button", { onClick: onClose, style: {
                                background: 'none',
                                border: 'none',
                                color: 'var(--text-muted)',
                                cursor: 'pointer',
                                padding: 4,
                            }, children: _jsx(X, { size: 20 }) })] }), _jsxs("div", { style: s.body, children: [_jsx("div", { style: s.sidebar, children: tabs.map((tab) => (_jsxs("button", { style: navItemStyle(activeTab === tab.id), onClick: () => setActiveTab(tab.id), children: [tab.icon, " ", tab.label] }, tab.id))) }), _jsxs("div", { style: s.content, children: [activeTab === 'appearance' && (_jsxs("div", { children: [_jsxs("div", { style: s.section, children: [_jsx("div", { style: s.sectionTitle, children: t('colorTheme') || 'Renk Teması' }), _jsx("div", { style: s.sectionDesc, children: t('pickapremiumcol109') || 'Premium bir tema seçin' }), _jsx("div", { style: s.themeGrid, children: THEMES.map((th) => (_jsxs("div", { style: themeCardStyle(theme === th.id), onClick: () => {
                                                            onSetTheme(th.id);
                                                            fetch('/save-settings', {
                                                                method: 'POST',
                                                                headers: {
                                                            ...
                                                            }, children: ["\u2600\uFE0F ", t('light') || 'Aydınlık'] }), _jsxs("button", { onClick: () => {
                                                                if (!isDark) {
                                                                    onToggleDark();
                                                                    fetch('/save-settings', {
                                                                        method: 'POST',
                                                ...
                                                }, children: [_jsx("span", { style: { fontSize: 24 }, children: "\uD83C\uDDF9\uD83C\uDDF7" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14 }, children: "T\u00FCrk\u00E7e" }), _jsx("div", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: t('turkishinterfac117') || 'Türkçe arayüz' })] }), language === 'tr' && (_jsx("span", { style: { color: 'var(--accent)', fontSize: 18 }, children: "\u2713" }))] }), _jsxs("div", { style: langCardStyle(language === 'en'), onClick: () => {
                                                    if (language !== 'en') {
                                                        onToggleLanguage();
                                                        fetch('/api/v1/set-language', {
                                                            method: 'POST',
                                                ...
                                                }, children: [_jsx("span", { style: { fontSize: 24 }, children: "\uD83C\uDDEC\uD83C\uDDE7" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14 }, children: "English" }), _jsx("div", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: t('englishinterfac118') || 'English interface' })] }), language === 'en' && (_jsx("span", { style: { color: 'var(--accent)', fontSize: 18 }, children: "\u2713" }))] }), _jsxs("div", { style: langCardStyle(language === 'de'), onClick: () => {
                                                    if (language !== 'de') {
                                                        onToggleLanguage();
                                                        fetch('/api/v1/set-language', {
                                                            method: 'POST',
                                                ...
                                                }, children: [_jsx("span", { style: { fontSize: 24 }, children: "\uD83C\uDDE9\uD83C\uDDEA" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14 }, children: "Deutsch" }), _jsx("div", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: "German interface" })] }), language === 'de' && (_jsx("span", { style: { color: 'var(--accent)', fontSize: 18 }, children: "\u2713" }))] }), _jsxs("div", { style: langCardStyle(language === 'fr'), onClick: () => {
                                                    if (language !== 'fr') {
                                                        onToggleLanguage();
                                                        fetch('/api/v1/set-language', {
                                                            method: 'POST',
                                                ...
                                                }, children: [_jsx("span", { style: { fontSize: 24 }, children: "\uD83C\uDDEB\uD83C\uDDF7" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14 }, children: "Fran\u00E7ais" }), _jsx("div", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: "French interface" })] }), language === 'fr' && (_jsx("span", { style: { color: 'var(--accent)', fontSize: 18 }, children: "\u2713" }))] }), _jsxs("div", { style: langCardStyle(language === 'es'), onClick: () => {
                                                    if (language !== 'es') {
                                                        onToggleLanguage();
                                                        fetch('/api/v1/set-language', {
                                                            method: 'POST',
                                                ...
                                                }, children: [_jsx("span", { style: { fontSize: 24 }, children: "\uD83C\uDDEA\uD83C\uDDF8" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14 }, children: "Espa\u00F1ol" }), _jsx("div", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: "Spanish interface" })] }), language === 'es' && (_jsx("span", { style: { color: 'var(--accent)', fontSize: 18 }, children: "\u2713" }))] }), _jsxs("div", { style: langCardStyle(language === 'ar'), onClick: () => {
                                                    if (language !== 'ar') {
                                                        onToggleLanguage();
                                                        fetch('/api/v1/set-language', {
                                                            method: 'POST',
                                                ...
                                                }, children: [_jsx("span", { style: { fontSize: 24 }, children: "\uD83C\uDDF8\uD83C\uDDE6" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14 }, children: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629" }), _jsx("div", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: "Arabic interface" })] }), language === 'ar' && (_jsx("span", { style: { color: 'var(--accent)', fontSize: 18 }, children: "\u2713" }))] })] }) })), activeTab === 'account' && (_jsxs("div", { children: [_jsxs("div", { style: s.section, children: [_jsx("div", { style: s.sectionTitle, children: t('personalAvatar') || 'Profil Resmi' }), _jsx("div", { style: s.sectionDesc, children: t('uploadyourprofi119') || 'Profil resminizi yükleyin' }), _jsx("input", { ref: fileInputRef, type: "file", accept: "image/*", style: { display: 'none' }, onChange: async (e) => {
                                                    ...
                                                    } }), _jsxs("button", { onClick: () => fileInputRef.current?.click(), style: {
                                                        ...s.btnStatic,
                                                        background: 'var(--bg-surface)',
                                                        color: 'var(--text-primary)',
                                                        border: '1px solid var(--border)',
                                                    }, children: [_jsx(Upload, { size: 14 }), " ", t('upload') || 'Yükle'] })] }), _jsxs("div", { style: { ...s.section, marginTop: 32, borderTop: '1px solid var(--border)', paddingTop: 20 }, children: [_jsx("div", { style: s.sectionTitle, children: t('logout') || 'Güvenli Çıkış' }), _jsx("div", { style: { ...s.sectionDesc, marginBottom: 16 }, children: t('logout_description') || 'Mevcut oturumunuzu güvenli bir şekilde sonlandırın.' }), _jsx("button", { onClick: () => {
                                                        onLogout();
                                                        onClose();
                                                    }, style: {
                                                        ...s.btnStatic,
                                                        ...
                                                        gap: 12,
                                                        marginTop: 12,
                                                    }, children: [_jsxs("div", { children: [_jsx("label", { style: s.label, children: "\u0130kincil Renk" }), _jsx("input", { type: "color", value: brandSecondaryColor, onChange: (e) => setBrandSecondaryColor(e.target.value), style: {
                                                                        width: '100%',
                                                                        height: 36,
                                                                        border: '1px solid var(--border)',
                                                                        borderRadius: 6,
                                                                        ...
                                                                        cursor: 'pointer',
                                                                        padding: 2,
                                                                    } })] }), _jsxs("div", { children: [_jsx("label", { style: s.label, children: "Yaz\u0131 Tipi" }), _jsx("input", { style: s.input, value: brandFontPath, onChange: (e) => setBrandFontPath(e.target.value), placeholder: "Arial" })] })] })] }), _jsxs("div", { style: s.section, children: [_jsx("div", { style: s.sectionTitle, children: "Ses Klonlama (Voice Cloning)" }), _jsx("div", { style: s.sectionDesc, children: "Kendi sesinizi klonlamak i\u00E7in k\u0131sa bir ses kayd\u0131 y\u00FCkleyin" }), _jsx("input", { ref: voiceInputRef, type: "file", accept: "audio/*", style: { display: 'none' }, onChange: async (e) => {
                                                        const f = e.target.files?.[0];
                                                        if (f)
                                                            setPersonalVoice(await encodeFileAsBase64(f));
                                                    } }), _jsxs("button", { onClick: () => voiceInputRef.current?.click(), style: {
                                                        ...s.btnStatic,
                                                        background: 'var(--bg-surface)',
                                                        color: 'var(--text-primary)',
                                                        border: '1px solid var(--border)',
                                                    }, children: [_jsx(Upload, { size: 14 }), " Ses Dosyas\u0131 Y\u00FCkle"] }), personalVoice && (_jsx("div", { style: { marginTop: 4, fontSize: 11, color: 'var(--success)' }, children: "\u2713 Ses dosyas\u0131 y\u00FCklendi" }))] }), _jsxs("button", { onClick: saveSettings, disabled: saving, style: {
                                                ...s.btnStatic,
                                                background: 'var(--accent)',
                                                color: 'white',
                                                marginTop: 16,
                                            }, children: [saving ? _jsx(Loader, { size: 14, className: "spin" }) : _jsx(Save, { size: 14 }), t('saveSettings') || 'Kaydet'] })] })), activeTab === 'apikeys' && (_jsx(ApiKeyManager, { language: language, t: t, onShowToast: (msg, type) => window.showToast?.(type, 'API Anahtarları', msg) })), activeTab === 'credits' && (_jsx(CreditsPanel, { csrfToken: csrfToken })), activeTab === 'payments' && (_jsx(PaymentsPanel, { csrfToken: csrfToken })), activeTab === 'subscriptions' && (_jsx(SubscriptionsPanel, { csrfToken: csrfToken })), activeTab === 'characters' && (_jsxs("div", { children: [_jsxs("div", { style: s.section, children: [_jsx("div", { style: s.sectionTitle, children: "\u2728 Yeni Karakter Ekle" }), _jsx("div", { style: s.sectionDesc, children: "Videolar\u0131n\u0131zda @karakter_ad\u0131 ile \u00E7a\u011F\u0131rabilece\u011Finiz karakterler" }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: [_jsx("input", { style: s.input, value: newCharName, onChange: (e) => setNewCharName(e.target.value), placeholder: "Karakter ad\u0131 (\u00F6rn: sibel)" }), _jsx("textarea", { style: { ...s.input, minHeight: 60, resize: 'vertical' }, value: newCharDesc, onChange: (e) => setNewCharDesc(e.target.value), placeholder: "Fiziksel \u00F6zellikler (avatar promptu)" }), _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [_jsx("button", { onClick: () => setAvatarStyleSetting('realistic'), style: {
                                                                        ...s.btnStatic,
                                                                        flex: 1,
                                                                        justifyContent: 'center',
                                                                        background: avatarStyleSetting === 'realistic'
                                                                            ? 'var(--accent)'
                                                                            : 'var(--bg-surface)',
                                                                        color: avatarStyleSetting === 'realistic' ? 'white' : 'var(--text-muted)',
                                                                        border: '1px solid var(--border)',
                                                                    }, children: "Ger\u00E7ek\u00E7i" }), _jsx("button", { onClick: () => setAvatarStyleSetting('animatic'), style: {
                                                                        ...s.btnStatic,
                                                                        flex: 1,
                                                                        justifyContent: 'center',
                                                                        background: avatarStyleSetting === 'animatic'
                                                                            ? 'var(--accent)'
                                                                            : 'var(--bg-surface)',
                                                                        color: avatarStyleSetting === 'animatic' ? 'white' : 'var(--text-muted)',
                                                                        border: '1px solid var(--border)',
                                                                    }, children: "Animatik" })] }), _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [_jsx("input", { ref: charAvatarInputRef, type: "file", accept: "image/*", style: { display: 'none' }, onChange: async (e) => {
                                                                        const f = e.target.files?.[0];
                                                                        if (f)
                                                                            setNewCharAvatar(await encodeFileAsBase64(f));
                                                                    } }), _jsxs("button", { onClick: () => charAvatarInputRef.current?.click(), style: {
                                                                        ...s.btnStatic,
                                                                        background: 'var(--bg-surface)',
                                                                        color: 'var(--text-primary)',
                                                                        border: '1px solid var(--border)',
                                                                    }, children: [_jsx(Upload, { size: 14 }), " Foto\u011Fraf Y\u00FCkle"] }), _jsxs("button", { onClick: generateAvatar, disabled: generatingAvatar, style: {
                                                                        ...s.btnStatic,
                                                                        background: 'linear-gradient(135deg, #7F00FF, #FF007F)',
                                                                        color: 'white',
                                                                    }, children: [generatingAvatar ? (_jsx(Loader, { size: 14, className: "spin" })) : (_jsx(Sparkles, { size: 14 })), ' ', "SD Avatar \u00DCret"] }), newCharAvatar && (_jsxs("button", { onClick: () => setEditingAvatarUrl(newCharAvatar), style: {
                                                                        ...s.btnStatic,
                                                                        background: 'var(--bg-surface)',
                                                                        color: 'var(--text-primary)',
                                                                        border: '1px solid var(--border)',
                                                                    }, children: [_jsx(Wand2, { size: 14 }), " D\u00FCzenle"] })), _jsxs("button", { onClick: createCharacter, disabled: loading || !newCharName.trim(), style: { ...s.btnStatic, background: 'var(--accent)', color: 'white' }, children: [loading ? _jsx(Loader, { size: 14, className: "spin" }) : _jsx(User, { size: 14 }), " Ekle"] })] }), newCharAvatar && (_jsxs("div", { style: { display: 'flex', gap: 8, alignItems: 'center', marginTop: 4 }, children: [_jsx("img", { src: newCharAvatar, alt: "Avatar preview", style: { width: 80, height: 80, borderRadius: 8, objectFit: 'cover' } }), _jsxs("span", { style: { fontSize: 10, color: 'var(--text-muted)' }, children: ["Kaynak: ", newCharAvatar.startsWith('data:') ? 'AI/Yükleme' : 'URL'] })] })), editingAvatarUrl && (_jsx(PhotoEditor, { imageUrl: editingAvatarUrl, onSave: handleAvatarSave, onClose: () => setEditingAvatarUrl(null) }))] })] }), _jsxs("div", { style: s.section, children: [_jsxs("div", { style: s.sectionTitle, children: ["\uD83D\uDC65 Kay\u0131tl\u0131 Karakterler (", characters.length, ")"] }), characters.length === 0 ? (_jsx("div", { style: { fontSize: 13, color: 'var(--text-muted)', fontStyle: 'italic' }, children: "Hen\u00FCz karakter eklenmemi\u015F." })) : (characters.map((c) => (_jsxs("div", { style: s.charCard, children: [_jsx("div", { style: s.charAvatar, children: c.reference_image_base64 ? (_jsx("img", { src: c.reference_image_base64, alt: "", style: { width: '100%', height: '100%', objectFit: 'cover' } })) : (_jsx(User, { size: 18, style: { color: 'var(--accent)' } })) }), _jsxs("div", { style: { flex: 1 }, children: [_jsxs("div", { style: { fontWeight: 600, fontSize: 13 }, children: ["@", c.name] }), _jsx("div", { style: { fontSize: 11, color: 'var(--text-muted)' }, children: c.description || 'Açıklama yok' })] }), _jsx("button", { onClick: () => deleteCharacter(c.id), style: {
                                                                ...s.btnStatic,
                                                                background: 'rgba(239,68,68,0.1)',
                                                                color: 'var(--danger)',
                                                            }, children: _jsx(Trash2, { size: 14 }) })] }, c.id))))] })] }))] })] })] }) }));
}
