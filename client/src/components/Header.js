...
export function Header({ language: _language, theme: _theme, isDark: _isDark, activeTab: _activeTab, userCredits, onSetTheme: _onSetTheme, onToggleDark: _onToggleDark, onToggleLanguage: _onToggleLanguage, onSetActiveTab: _onSetActiveTab, onLogout: _onLogout, t: _t, }) {
    ...
    return (_jsxs("header", { style: {
            ...
            borderBottom: '1px solid rgba(255, 255, 255, 0.1)',
                            ...
                            boxShadow: '0 0 12px var(--accent-glow)',
                                    ...
                                    fontFamily: 'var(--font-mono)',
                                }, children: "Engine: v2.4 (Online)" })] }), _jsx("div", { style: {
