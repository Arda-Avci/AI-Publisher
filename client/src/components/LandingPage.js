    ...
    return (_jsxs("div", { style: {
      ...
      ` }), _jsx("div", { style: {
                    ...
                    background: 'rgba(9,9,11,0.8)',
                                    ...
                                    fontWeight: 'bold',
                                    letterSpacing: '0.5px',
                                }, children: "PRO" })] }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '16px' }, children: [_jsxs("button", { onClick: () => setLanguage(language === 'tr' ? 'en' : 'tr'), className: "btn btn-secondary", style: {
                                    padding: '6px 12px',
                                    fontSize: '12px',
                                    fontWeight: 'bold',
                                    borderRadius: '8px',
                                }, children: [_jsx(Globe, { size: 14, style: { marginRight: '4px' } }), language.toUpperCase()] }), _jsx("button", { onClick: () => {
                                    setAuthError('');
                                    setIsLoginOpen(true);
                                    ...
                                    borderRadius: '8px',
                                    padding: '8px 20px',
                                }, children: t('login') || 'Giriş Yap' })] })] }), _jsxs("section", { className: "premium-landing-hero", children: [_jsxs("div", { className: "premium-landing-hero-left", children: [_jsxs("div", { className: "premium-landing-hero-badge", children: [_jsx(Sparkles, { size: 12 }), _jsx("span", { children: t('heroBadge') || 'Otonom Video Üretiminin Geleceği' })] }), _jsx("h1", { className: "premium-landing-hero-title", children: t('landingTitle') ? (_jsxs(_Fragment, { children: ["AI-Publisher ile ", _jsx("span", { children: "Otonom" }), _jsx("br", {}), "Pazarlama ve ", _jsx("span", { children: "Video" }), " \u00C7a\u011F\u0131"] })) : (t('landingTitle')) }), _jsx("p", { className: "premium-landing-hero-subtitle", children: t('landingSubtitle') }), _jsxs("div", { className: "premium-landing-hero-ctas", children: [_jsxs("button", { onClick: () => setIsLoginOpen(true), className: "btn btn-primary premium-landing-btn", children: [t('heroCTA') || 'Hemen Başla', " ", _jsx(ArrowRight, { size: 18 })] }), _jsxs("button", { onClick: scrollToGallery, className: "btn btn-secondary premium-landing-btn-secondary", children: [_jsx(Play, { size: 16 }), " \u00D6rnekleri \u0130zle"] })] })] }), _jsx("div", { className: "premium-landing-hero-right", children: _jsxs("div", { className: "premium-landing-hero-video hero-float", children: [_jsx("div", { className: "premium-landing-video-overlay" }), _jsx("div", { className: "premium-landing-play-container", children: _jsx("div", { className: "hero-play-btn premium-landing-play-btn", onClick: scrollToGallery, children: _jsx(Play, { size: 28, fill: "white", style: { marginLeft: '3px' } }) }) })] }) })] }), _jsx("div", { className: "hero-stats", style: {
                    display: 'flex',
                    gap: '48px',
                    justifyContent: 'center',
                    alignItems: 'center',
                ...
                ].map((stat, i) => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' }, children: [_jsx("span", { className: "gradient-text", style: { fontSize: '28px', fontWeight: 800, fontFamily: 'var(--font-mono)' }, children: stat.num }), _jsx("span", { style: { fontSize: '14px', color: 'var(--text-muted)', fontWeight: 500 }, children: stat.label }), i < 2 && (_jsx("div", { style: {
                                width: '1px',
                                height: '30px',
                                background: 'var(--border)',
                                marginLeft: '12px',
                            } }))] }, i))) }), _jsxs("section", { ref: galleryRef, style: {
                    position: 'relative',
                    zIndex: 1,
                    maxWidth: '1200px',
                    margin: '0 auto',
                    ...
                    scrollMarginTop: '80px',
                            ...
                            gap: '24px',
                                ...
                                borderRadius: '12px',
                                overflow: 'hidden',
                            }, children: [_jsx("div", { className: "pulse", style: { height: '160px', background: 'var(--bg-surface)' } }), _jsxs("div", { style: { padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }, children: [_jsx("div", { className: "pulse", style: {
                                                height: '14px',
                                                width: '70%',
                                                background: 'var(--bg-surface)',
                                                borderRadius: '4px',
                                            } }), _jsx("div", { className: "pulse", style: {
                                                height: '10px',
                                                width: '50%',
                                                background: 'var(--bg-surface)',
                                                borderRadius: '4px',
                                    ...
                                    return (_jsxs("div", { className: "glass gallery-card", style: {
                                            ...
                                            e.currentTarget.style.borderColor = 'var(--border)';
                                                    ...
                                                    borderBottom: '1px solid var(--border)',
                                                            ...
                                                            borderRadius: '20px',
                                                            fontWeight: 600,
                                                        }, children: cat })] }), _jsxs("div", { style: { padding: '16px' }, children: [_jsxs("h4", { style: {
                                                            fontSize: '14px',
                                                            fontWeight: 700,
                                                            margin: 0,
                                                            color: 'var(--text-primary)',
                                                        }, children: [cat, " ", t('categoryLabel')] }), _jsxs("p", { style: {
                                                            fontSize: '12px',
                                                            color: 'var(--text-muted)',
                                                            margin: '6px 0 0',
                                                            lineHeight: '1.4',
                                                        }, children: [t('aiGeneratedSample'), " ", cat.toLowerCase(), " ", t('videoLabel')] })] })] }, cat));
                                })
                                : filteredVideos.map((video) => (_jsxs("div", { onClick: () => setSelectedVideo(video), className: "glass gallery-card", style: {
                                        ...
                                        e.currentTarget.style.borderColor = 'var(--border)';
                                                ...
                                                borderBottom: '1px solid var(--border)',
                                                    ...
                                                    }, children: video.production_template || 'GENEL' })] }), _jsxs("div", { style: {
                                                padding: '16px',
                                                display: 'flex',
                    ...
                    padding: '60px 40px 80px',
                            ...
                            minHeight: '320px',
                                    ...
                                    e.currentTarget.style.boxShadow = 'none';
                                            ...
                                            justifyContent: 'center',
                                            color: 'var(--accent)',
                                        }, children: _jsx(Film, { size: 28 }) }), _jsxs("div", { children: [_jsx("h3", { style: { fontSize: '22px', fontWeight: 700, margin: 0 }, children: t('aiVideoProduction') }), _jsx("p", { style: {
                                                    fontSize: '14px',
                                                    color: 'var(--text-muted)',
                                                    lineHeight: '1.6',
                                                    marginTop: '12px',
                                                    maxWidth: '440px',
                                                }, children: t('cogVideoDesc') })] })] }), _jsxs("div", { className: "glass bento-card", style: {
                                    gridRow: '1 / 2',
                                    borderRadius: '16px',
                                    padding: '32px',
                                    display: 'flex',
                                    ...
                                    e.currentTarget.style.boxShadow = 'none';
                                            ...
                                            justifyContent: 'center',
                                            color: 'var(--secondary)',
                                        }, children: _jsx(Music, { size: 24 }) }), _jsxs("div", { children: [_jsx("h3", { style: { fontSize: '18px', fontWeight: 700, margin: 0 }, children: "Ses & Lip-Sync" }), _jsx("p", { style: {
                                                    fontSize: '13px',
                                                    color: 'var(--text-muted)',
                                                    lineHeight: '1.5',
                                                    marginTop: '8px',
                                                }, children: "XTTS-v2 \u00E7ok dilli ses sentezi ve Wav2Lip dudak senkronizasyonu ile ger\u00E7ek\u00E7i karakter seslendirmesi." })] })] }), _jsxs("div", { className: "glass bento-card", style: {
                                    gridRow: '2 / 3',
                                    borderRadius: '16px',
                                    padding: '32px',
                                    display: 'flex',
                                    ...
                                    e.currentTarget.style.boxShadow = 'none';
                                            ...
                                            justifyContent: 'center',
                                            color: 'var(--success)',
                                        }, children: _jsx(Share2, { size: 24 }) }), _jsxs("div", { children: [_jsx("h3", { style: { fontSize: '18px', fontWeight: 700, margin: 0 }, children: "Otomatik Yay\u0131nla" }), _jsx("p", { style: {
                                                    fontSize: '13px',
                                                    color: 'var(--text-muted)',
                                                    lineHeight: '1.5',
                                                    marginTop: '8px',
                                                }, children: "Playwright botlar\u0131 ile YouTube, TikTok, X ve Meta Reels hesaplar\u0131nda tek t\u0131kla yay\u0131n." })] })] })] })] }), _jsx("section", { style: {
                    position: 'relative',
                    zIndex: 1,
                    maxWidth: '1200px',
                    margin: '0 auto',
                    ...
                    padding: '60px 40px',
                        ...
                        { num: '4', label: t('socialMediaPlatforms') },
                                    ...
                                    fontFamily: 'var(--font-mono)',
                                    lineHeight: 1,
                                }, children: stat.num }), _jsx("div", { style: {
                                    color: 'var(--text-muted)',
                                    fontSize: '14px',
                                    marginTop: '6px',
                                    fontWeight: 500,
                                }, children: stat.label })] }, i))) }) }), _jsx("section", { className: "reveal-on-scroll", style: {
                    position: 'relative',
                    zIndex: 1,
                    maxWidth: '1200px',
                    margin: '0 auto',
                        ...
                        alignItems: 'flex-start',
                                ...
                                { title: 'Resources', links: ['Dokümantasyon', 'API Referans', 'Blog', 'Topluluk'] },
                                {
                                    ...
                                    links: ['Hakkımızda', 'İletişim', 'Gizlilik', 'Kullanım Şartları'],
                                            ...
                                            e.currentTarget.style.color = 'var(--text-muted)';
                                        }, children: link }, link)))] }, group.title))) })] }) }), selectedVideo && (_jsx("div", { className: "modal-backdrop", style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    width: '100vw',
                    ...
                    zIndex: 100,
                        ...
                        boxShadow: '0 20px 50px rgba(0,0,0,0.6)',
                                ...
                                alignItems: 'center',
                                borderBottom: '1px solid var(--border)',
                            }, children: [_jsx("span", { style: { fontWeight: 'bold', fontSize: '14px', color: 'var(--accent)' }, children: "Video Detay" }), _jsx("button", { onClick: () => setSelectedVideo(null), style: {
                                        background: 'none',
                                        border: 'none',
                                        color: 'white',
                                        cursor: 'pointer',
                                ...
                                overflowY: 'auto',
                                        ...
                                        minHeight: '350px',
                                    }, children: [_jsx("video", { src: `/videolar/${selectedVideo.final_filename}`, controls: true, autoPlay: true, style: {
                                                maxWidth: '100%',
                                                maxHeight: '400px',
                                                borderRadius: '8px',
                                                border: '1px solid var(--border)',
                                            } }), _jsxs("div", { style: { display: 'flex', gap: '10px', marginTop: '15px' }, children: [_jsxs("a", { href: `/videolar/${selectedVideo.final_filename}`, download: true, className: "btn btn-secondary", style: { fontSize: '11px', padding: '6px 12px' }, children: [_jsx(Download, { size: 12 }), " Yatay \u0130ndir"] }), _jsxs("a", { href: `/videolar/shorts_${selectedVideo.final_filename.replace(/^demo_video_/, '')}`, download: true, className: "btn btn-primary", style: { fontSize: '11px', padding: '6px 12px' }, children: [_jsx(Download, { size: 12 }), " Dikey \u0130ndir"] })] })] }), _jsxs("div", { style: {
                                        padding: '24px',
                                        display: 'flex',
                                        flexDirection: 'column',
                                        gap: '20px',
                                        overflowY: 'auto',
                                    }, children: [_jsxs("div", { children: [_jsx("h3", { style: { fontSize: '18px', fontWeight: 'bold', margin: 0 }, children: selectedVideo.master_prompt }), _jsxs("div", { style: { display: 'flex', gap: '8px', marginTop: '8px' }, children: [_jsxs("span", { style: {
                                                                fontSize: '10px',
                                                                background: 'var(--accent-glow)',
                                                                color: 'var(--accent)',
                                                                padding: '2px 8px',
                    ...
                    zIndex: 100,
                        ...
                        position: 'relative',
                                ...
                                borderRadius: '6px',
                                        ...
                                        e.currentTarget.style.borderColor = 'var(--border)';
                                    } })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px' }, children: [_jsx("label", { style: { fontSize: '12px', color: 'var(--text-muted)' }, children: "\u015Eifre" }), _jsx("input", { type: "password", required: true, value: password, onChange: (e) => setPassword(e.target.value), style: {
                                        background: '#070a14',
                                        border: '1px solid var(--border)',
                                        borderRadius: '8px',
                                        color: 'white',
                                        ...
                                        e.currentTarget.style.borderColor = 'var(--border)';
                                    } })] }), _jsx("button", { type: "submit", disabled: loginLoading, className: "btn btn-primary", style: {
                                padding: '12px',
                                width: '100%',
                                fontWeight: 'bold',
                                fontSize: '14px',
                                borderRadius: '8px',
                                marginTop: '10px',
                            }, children: loginLoading ? _jsx(Loader, { size: 14, className: "pulse" }) : 'Giriş Yap' })] }) }))] }));
}
