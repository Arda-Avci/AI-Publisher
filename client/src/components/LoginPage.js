...
export function LoginPage({ language, setLanguage, onLogin, authError, setAuthError }) {
    ...
    return (_jsxs("div", { style: {
            ...
            position: 'relative', overflow: 'hidden',
                ...
                }, children: [_jsxs("div", { style: { textAlign: 'center', marginBottom: 32 }, children: [_jsx("div", { style: {
                                    width: 48, height: 48, borderRadius: '50%',
                                    background: 'linear-gradient(135deg, var(--accent), var(--secondary))',
                                    display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
                                    marginBottom: 16, boxShadow: '0 0 20px var(--accent-glow)',
                                }, children: _jsx(Film, { size: 24, color: "white" }) }), _jsxs("h1", { style: {
                                    fontFamily: 'var(--font-serif)', fontSize: 28, fontWeight: 600,
                                    margin: 0, letterSpacing: '-0.02em',
                                }, children: ["AI ", _jsx("span", { style: { color: 'var(--accent)' }, children: "Publisher" })] }), _jsx("p", { style: { color: 'var(--text-muted)', fontSize: 13, marginTop: 8 }, children: t('loginSubtitle') })] }), _jsxs("form", { onSubmit: handleSubmit, children: [_jsxs("div", { style: { marginBottom: 16 }, children: [_jsx("label", { style: { display: 'block', fontSize: 11, color: 'var(--text-muted)', marginBottom: 6, fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.05em' }, children: t('usernameLabel') }), _jsx("input", { value: username, onChange: e => setUsername(e.target.value), style: {
                                            width: '100%', padding: '10px 14px', borderRadius: 8,
                                            border: '1px solid var(--border)', background: 'var(--bg-primary)',
                                            color: 'var(--text-primary)', fontSize: 14, outline: 'none',
                                            boxSizing: 'border-box',
                                        }, placeholder: t("loginPlaceholderUsername"), required: true })] }), _jsxs("div", { style: { marginBottom: 20 }, children: [_jsx("label", { style: { display: 'block', fontSize: 11, color: 'var(--text-muted)', marginBottom: 6, fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.05em' }, children: t('passwordLabel') }), _jsx("input", { type: "password", value: password, onChange: e => setPassword(e.target.value), style: {
                                            width: '100%', padding: '10px 14px', borderRadius: 8,
                                            border: '1px solid var(--border)', background: 'var(--bg-primary)',
                                            color: 'var(--text-primary)', fontSize: 14, outline: 'none',
                                            boxSizing: 'border-box',
