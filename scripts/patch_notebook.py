    ...
    if cell.get("cell_type") == "code":
        ...
        if has_docker_setup:
            new_source = [
                ...
                'print("==========================================")\n',
                '\n',
                'if os.path.exists("/content/AI-Publisher"):\n',
                '  os.chdir("/content/AI-Publisher")\n',
                'elif os.path.exists("AI-Publisher"):\n',
                '  os.chdir("AI-Publisher")\n',
                '\n',
                'if not os.path.exists("colab_docker/build_all.sh"):\n',
                '  print("❌ Hata: AI-Publisher deposu klonlanmamış veya colab_docker/build_all.sh bulunamadı!")\n',
                '  print("👉 Lütfen önce 1. Hücreyi çalıştırarak GitHub deposunun klonlanmasını sağlayın, ardından bu hücreyi tekrar çalıştırın.")\n',
                '  sys.exit(1)\n',
                '\n',
