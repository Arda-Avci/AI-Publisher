...
const TEMPLATE_DESCRIPTIONS: Record<ProductionTemplate, TemplateMeta> = {
  ...
  noir: {
    title: 'Noir',
    description: 'Kara film estetiği, yüksek kontrast, derin gölgeler, keskin ışık-gölge oyunu.',
  ...
  epic: {
    title: 'Epik',
    description: 'Büyük ölçekli destansı sahneler, geniş kadrajlar ve görkemli görüntüler.',
  ...
  atmospheric: {
    title: 'Atmosferik',
    description: 'Sis, ışık hüzmesi, volümetrik efektler ve yoğun ruh hali odaklı görüntüler.',
  ...
  dynamic: {
    title: 'Dinamik',
    description: 'Hızlı kesmeler, geniş açılar ve yüksek enerjili görsel akış.',
  ...
  viral_tiktok: {
    title: 'Viral TikTok',
    description: 'İlk 3 saniyede dikkat çeken, trend efektli, hızlı tempolu dikey içerik.',
  ...
  shorts_fast: {
    title: 'Shorts Hızlı',
    description: 'YouTube Shorts için hızlı kesmeler, metin overlay ve yüksek enerji.',
  ...
  reel_aesthetic: {
    title: 'Reel Estetik',
    description: 'Instagram Reels için yumuşak renk paletleri, akıcı geçişler ve görsel uyum.',
  ...
  trending: {
    title: 'Trend Takipçi',
    description: 'Anlık trendleri video formatına uyarlayan, güncel ve paylaşılabilir içerik.',
  ...
  challenge: {
    title: 'Meydan Okuma',
    description: 'Katılımcı, eğlenceli ve paylaşılabilir challenge videoları.',
  ...
  asmr: {
    title: 'ASMR',
    description: 'Rahatlatıcı sesler ve görüntülerle duyusal bir deneyim.',
  ...
  unboxing: {
    title: 'Unboxing',
    description: 'Ürün açılışı, ilk izlenim ve detaylı inceleme odaklı içerik.',
  ...
  simple: {
    title: 'Basit',
    description: 'Minimal, direkt ve net. Bilgilendirici içerik için temiz ve sade tasarım.',
  ...
  tutorial: {
    title: 'Eğitici',
    description: 'Adım adım anlatım, net görseller ve takip edilmesi kolay eğitim içeriği.',
  ...
  whiteboard: {
    title: 'Beyaz Tahta',
    description: 'El çizimi animasyonlar, grafikler ve görsel anlatımın gücü.',
  ...
  explainer: {
    title: 'Açıklayıcı',
    description: 'Karmaşık konuları basit animasyonlar ve net görsellerle anlatma.',
  ...
  keynote: {
    title: 'Sunum',
    description: 'Profesyonel slayt geçişleri, grafik animasyonları ve etkileyici görseller.',
  ...
  documentary: {
    title: 'Belgesel',
    description: 'Gerçekçi, bilgilendirici ve etkileyici görsel hikaye anlatımı.',
  ...
  pixar: {
    title: 'Pixar Tarzı',
    description: 'Sevimli karakterler, renkli dünyalar ve duygusal hikaye anlatımı.',
  ...
  anime: {
    title: 'Anime',
    description: 'Japon animasyon tarzı, belirgin çizgiler, canlı renkler ve dinamik sahneler.',
  ...
  retro_vhs: {
    title: 'Retro VHS',
    description: "80'ler/90'lar analog estetik, renk bozulmaları, tarama çizgileri.",
  ...
  glitch_art: {
    title: 'Glitch Art',
    description: 'Dijital bozulma, renk kayması, RGB split ve hata efektleri.',
  ...
  claymation: {
    title: 'Claymation',
    description: 'El yapımı kil karakterler, kare kare animasyon ve dokunsal estetik.',
  ...
  stop_motion: {
    title: 'Stop Motion',
    description: 'Nesneleri kare kare hareket ettirerek akıcı animasyon oluşturma.',
  ...
  gaming_montage: {
    title: 'Oyun Montaj',
    description: 'Epik oyun anları, hızlı kesmeler ve yüksek enerjili oyun içerikleri.',
  ...
  fitness: {
    title: 'Fitness',
    description: 'Egzersiz gösterimleri, antrenman akışı ve motivasyonel içerik.',
  ...
  cooking: {
    title: 'Yemek',
    description: 'Yemek pişirme süreci, malzeme hazırlığı ve iştah açıcı sunum.',
  ...
  travel_vlog: {
    title: 'Seyahat Vlog',
    description: 'Doğal manzaralar, kültürel deneyimler ve macera dolu seyahat içerikleri.',
  ...
  corporate: {
    title: 'Kurumsal',
    description: 'Profesyonel şirket tanıtımı, ürün lansmanı ve marka hikayesi anlatımı.',
  ...
  luxury: {
    title: 'Lüks',
    description: 'Premium görüntü kalitesi, zarif kamera hareketleri ve sofistike estetik.',
  ...
  wedding: {
    title: 'Düğün',
    description: 'Romantik çekimler, duygusal anlar ve sinematik düğün hikayesi.',
  ...
  real_estate: {
    title: 'Emlak',
    description: 'Mekan turları, mimari detaylar ve yaşam alanı tanıtımları.',
...
function generateStaticTemplatePreview(
  template: ProductionTemplate,
  niche?: string,
): TemplatePreview {
  const desc = TEMPLATE_DESCRIPTIONS[template];
