...
export function registerPipecatRoutes(app: Application): void {
  app.post('/api/v1/pipecat/start-server', heavyLimiter, requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/v1/pipecat/stop-server', heavyLimiter, requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/v1/pipecat/pipeline', heavyLimiter, requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.get('/api/v1/pipecat/pipeline/:pipelineId', requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/v1/pipecat/avatar/generate', heavyLimiter, requireAuth, async (req: Request, res: Response) => {
    try {
  ...
  app.post('/api/v1/pipecat/broadcast', heavyLimiter, requireAuth, async (req: Request, res: Response) => {
    try {
