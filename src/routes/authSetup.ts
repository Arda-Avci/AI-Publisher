...
export function registerAuthSetupRoutes(app: Application): void {
  ...
  registerRoute(app, 'get', '/auth-status/:platform', requireAuth, async (req: Request, res: Response) => {
    await handleAuthStatus(req, res);
  });

  registerRoute(app, 'post', '/auth-setup/:platform', requireAuth, async (req: Request, res: Response) => {
    await handleAuthSetup(req, res);
  });

  registerRoute(app, 'delete', '/auth-setup/:platform', requireAuth, async (req: Request, res: Response) => {
